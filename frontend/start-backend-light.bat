@echo off
echo Starting INGRES RAG API Server (Light Version)...
echo.
...
REM Install lighter dependencies
echo Installing lighter dependencies...
...
REM Start the FastAPI server with light version
